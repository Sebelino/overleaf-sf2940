...
Property (I):
\begin{align*}
	& \mathcal{A}_1 \text{ is }\sigma\text{-algebra} \wedge \mathcal{A}_2 \text{ is }\sigma\text{-algebra} \\
...
Then \(A \in \mathcal{A}_1\) and \(A \in \mathcal{A}_2\).

Then \(A^\complement \in \mathcal{A}_1\) and \(A^\complement \in \mathcal{A}_2\).

Then \(A^\complement \in \mathcal{A}_1\) and \(A^\complement \in \mathcal{A}_2\).

Then \(A^\complement \in \mathcal{A}_1\cap \mathcal{A}_2\).

So \(\forall A\in \mathcal{A}_1\cap\mathcal{A}_2 : A^\complement\in \mathcal{A}_1\cap\mathcal{A}_2\).

Property (III):

Let \((A_n)_{n=1}^\infty\) be a sequence of sets such that
\[\bigwedge_{n=1}^\infty A_n\in \mathcal{A}_1\cap\mathcal{A}_2\]

Then \(A_n\in \mathcal{A}_1\) and \(A_n\in \mathcal{A}_2\), for each \(A_n\).
\[\bigwedge_{n=1}^\infty A_n\in \mathcal{A}_1\]

Suppose
An in A1 cap A2, n=1,2,3,...

Then An in A1 and An in A2

Then
\(\cup_{n=1}^\infty A_n \in A_1\)
\(\cup_{n=1}^\infty A_n \in A_2\)
so
\(\cup_{n=1}^\infty A_n \in A_1 \cap A_2\)

\section{Exercise 2.23.4.7 (Markov's inequality)}
...
is the random variable \(\mathbb{1}_A(\omega)=\casesii{1}{\omega\in A}{0}\)

\begin{proof}

Observe:

	\[E[\mathbb{1}_A] = 0 \cdot P(\mathbb{1}=0)+1\cdot P(\mathbb{1}=1)\]
	\[ = P(\{\omega\in\Omega : \mathbb{1}(\omega)=1\})\]
	\[ = P(A)\]
...
\[P(X\geq c) = P(E_C)=E[\mathbb{1}_{E_C}]\]

\[E[X] \geq E[Y]\]

\[P(X\geq c) = \frac1c E[c\mathbb{1}_{E_C}] = \frac1c E[X]]\]
...
\section{Misc problem 1}

Prove \(P(a < X \leq b) = F_X(b)-F_X(b)\).

\textbf{Solution:}

\section{Exercise 2.6.2.4}
...
\[f_Y(y)=\frac{\mathbb{1}_{|x|, 1}(y)}{1-|x|}\]
